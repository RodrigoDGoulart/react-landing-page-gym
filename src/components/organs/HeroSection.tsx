...
const HeroSection = () => {
    ...
    return (
        <section className="w-full h-auto bg-gradient-to-r from-green-950 to-green-500 relative overflow-x-hidden">
                        ...
                        <main className="w-full lg:h-screen md:h-[50vh] h-screen relative bg-zinc-900 overflow-x-hidden" key={index}>
                            ...
                            <div className="md:w-[50%] w-full md:h-full h-1/2 absolute md:top-0 top-1/2 right-0 bg-zinc-900 flex flex-col md:justify-center justify-start lg:gap-8 md:gap-4 gap-2 lg:px-20 md:px-6 px-4 overflow-x-hidden">
                                ...
                                <div className="flex items-center gap-8">
                                    <Slide direction="up">
                                        <Button type="button" className="px-10 font-medium text-white py-2.5 bg-gradient-to-r whitespace-nowrap from-green-950 to-green-500">
                                            {hero.Button}
                                        </Button>
                                    </Slide>
                                    <Slide direction="up">
                                        <a href="/" className="flex items-center gap-2 text-green-950 hover:text-green-500 group">
                                            <YoutubeLogo size={20} color="currentColor" weight="fill" />
                                            <Text as="span" className="text-zinc-100 group-hover:text-green-500 uppercase text-xs">Watch reviews</Text>
                                        </a>
                                    </Slide>
                                </div>
                            </div>
            ...
            <div className="flex justify-end lg:justify-start items-center gap-4 absolute lg:bottom-10 md:bottom-5 md:right-10 right-4 bottom-4">
                <Button onClick={previous} type="button" className="w-8 h-8 border rounded-full border-green-500 flex items-center justify-center text-green-500 hover:text-green-950 hover:border-green-950">
                    <ArrowCircleLeft size={20} color="currentColor" weight="light" />
                </Button>
                <Button onClick={next} type="button" className="w-8 h-8 border rounded-full border-green-500 flex items-center justify-center text-green-500 hover:text-green-950 hover:border-green-950">

        ...
        <section className="w-full h-auto flex items-center bg-zinc-950">
            <main className="w-full md:h-[700px] grid md:grid-cols-2 items-center lg:mx-20 md:mx-10 mx-6 gap-10 md:gap-10 py-12 md:py-0">
                <div className="h-full w-full md:order-1 order-2 flex flex-col justify-center items-start gap-4 pb-8 md:pb-12">
                    <Fade>
                        <div className="flex flex-col mt-10 items-start relative before:absolute before:-bottom-6 before:left-0 before:w-20 before:h-1 before:rounded-lg before:bg-gradient-to-r before:from-green-500 before:to-green-950 z-10">
                            <Text as="p" className="text-green-500 lg:text-sm text-xs tracking-widest uppercase font-medium">{AboutTexts.firstText}</Text>
                ...
                <div className="w-full md:h-[400px] h-[300px] md:order-2 order-1 grid grid-cols-3 grid-rows-3">
                    ...
                    <Image alt="Welcome Image" objectCover="object-cover" className="w-full h-full border border-green-500" image={Image3} />

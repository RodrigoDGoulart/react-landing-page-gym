...
import CalImg from "../../assets/gym/9.jpg"
            ...
            <main className="w-full lg:h-[800px] grid md:grid-cols-2 items-center gap-20 md:gap-0 lg:gap-8 ">
                ...
                <div className="h-full w-full md:order-1 order-2 pt-12 md:pt-0 lg:px-8 px-4 flex flex-col lg:justify-center justify-center items-start lg:gap-20 gap-16">
                    <Fade className="w-full">
                        <div className="w-full flex flex-col mt-10 items-center relative before:absolute before:-bottom-6 before:left-38 before:w-20 before:h-1 before:rounded-lg before:bg-gradient-to-r before:from-green-500 before:to-green-950 z-10">
                            <Text as="p" className="text-green-500 lg:text-sm text-xs tracking-widest uppercase font-medium">Calculadora Avançada</Text>
                            <Text as="h1" className="text-zinc-100 lg:text-5xl md:text-4xl text-3xl">Calcule seu IMC</Text>
